...
| <a name="output_oidc_provider_arn"></a> [oidc\_provider\_arn](#output\_oidc\_provider\_arn) | ARN of OIDC provider. |
| <a name="output_worker_group_arn"></a> [worker\_group\_arn](#output\_worker\_group\_arn) | Worker gorup ARN |
| <a name="output_worker_group_role_arn"></a> [worker\_group\_role\_arn](#output\_worker\_group\_role\_arn) | Worker gorup IAM role ARN |
